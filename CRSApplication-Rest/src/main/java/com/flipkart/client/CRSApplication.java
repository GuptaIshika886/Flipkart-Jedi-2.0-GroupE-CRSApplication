...
//	NotificationInterface notificationInterface=NotificationOperation.getInstance();
	...
	public void registerStudent() {
		...
		try {
			...
			Student student = new Student(userId,name,RoleConstant.STUDENT,password,gender,address,branchName,userId,batch,false);
			String newStudentId = studentInterface.register(student);
